  ...
  const solutions = [
    {
      ...
      description: "Automate your sales process with an AI agent that handles lead qualification, product inquiries, and customer interactions.",
      features: [
    ...
    },
    {
      ...
      description: "Eliminate scheduling headaches with an AI system that manages your calendar intelligently.",
      features: [
        "Multi-calendar sync",
    ...
    },
    {
      ...
      description: "Transform your customer service with a 24/7 virtual receptionist that handles calls professionally.",
      features: [
